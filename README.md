...
![Language](https://img.shields.io/badge/backend-C++17-green.svg)
...
* **🎛️ Dual Mode:** * **Capture Mode:** Low-latency microphone input for visualizers.
...
*(Add your GIFs here in the `screenshots` folder)*

<p align="center">
  <img src="screenshots/demo_capture.gif" alt="Microphone Visualizer" width="45%" style="margin-right: 10px;">
  <img src="screenshots/demo_playback.gif" alt="Subtitle Sync" width="45%">
</p>
